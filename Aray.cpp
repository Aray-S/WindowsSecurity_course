...
// Aray.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CArayApp, CWinApp)
...
// Единственный объект CArayApp

CArayApp theApp;


// Инициализация CArayApp

BOOL CArayApp::InitInstance()
{
